...
using static LSP2GXL.LSP.LSPLanguage;
...
public record LSPServer
{
                      ...
                      string parameters = "", IDictionary<string, object>? initOptions = null)
    {
        ...
        InitOptions = initOptions ?? new Dictionary<string, object>();
        All.Add(this);
    }
    ...
    {
        ReadOnlyDictionary<string, string> languageIds = Languages.FirstOrDefault(language => language.FileExtensions.Contains(extension))?
                                                                  .LanguageIds
                                                                  .AsReadOnly()!;
        return languageIds.GetValueOrDefault(extension, string.Empty);
    }
    ...
    //       please make sure that it actually works in LSP2GXL, since we have some special requirements
    ...
    public static readonly LSPServer HaskellLanguageServer = new("haskell-ls",
                                                                 "https://haskell-language-server.readthedocs.io/en/latest/",
                                                                 new List<LSPLanguage> { Haskell },
                                                                 "haskell-language-server", "--lsp");

    public static readonly LSPServer EclipseJdtls = new("Eclipse-JDTLS",
                                                        "https://github.com/eclipse-jdtls/eclipse.jdt.ls",
                                                        new List<LSPLanguage> { Java },
                                                        "jdtls");

    public static readonly LSPServer TypescriptLanguageServer = new("Typescript-LS",
                                                                    "https://github.com/typescript-language-server/typescript-language-server",
                                                                    new List<LSPLanguage> { TypeScript, JavaScript },
                                                                    "typescript-language-server", "--stdio");

    public static readonly LSPServer VscodeJson = new("VSCode-JSON-LS",
    ...
    public static readonly LSPServer LuaLanguageServer = new("Lua-LS",
    ...
    public static readonly LSPServer MatlabLanguageServer = new("Matlab-LS",
    ...
    public static readonly LSPServer DartAnalysisServer = new("Dart-LS",
                                                              "https://github.com/dart-lang/sdk/blob/master/pkg/analysis_server/tool/lsp_spec/README.md",
                                                              new List<LSPLanguage> { Dart },
                                                              "dart", "language-server");

    public static readonly LSPServer KotlinLanguageServer = new("Kotlin-LS",
    ...
    public static readonly LSPServer Jedi = new("Jedi-LS",
    ...
    {
        return All.SingleOrDefault(server => server.Name.Equals(name, StringComparison.InvariantCultureIgnoreCase));
    }
}
