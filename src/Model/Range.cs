...
public record Range(int StartLine, int EndLine, int? StartCharacter = null, int? EndCharacter = null) : IComparable<Range>
{
    ...
    public bool Contains(Range other)
    {
        ...
        {
            Debug.Assert(!other.StartCharacter.HasValue && !other.EndCharacter.HasValue);
    ...
    {
        return new Range(lspRange.Start.Line+1, lspRange.End.Line+1, lspRange.Start.Character+1, lspRange.End.Character+1);
    }
    ...
    public int CompareTo(Range? other)
    {
        ...
        if (StartLine == other.StartLine)
        {
            ...
            {
                Debug.Assert(EndCharacter.HasValue && other.EndCharacter.HasValue);
